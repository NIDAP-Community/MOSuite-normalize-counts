...
parser$add_argument("--samples_to_rename", type="character", default="", help="Sample renaming pairs: old:new,old2:new2")
parser$add_argument("--add_label_to_pca", type="logical", default=TRUE, help="Label points on the PCA plot")
parser$add_argument("--principal_component_on_x_axis", type="integer", default=1, help="PCA component on x-axis")
parser$add_argument("--principal_component_on_y_axis", type="integer", default=2, help="PCA component on y-axis")
parser$add_argument("--legend_position_for_pca", type="character", default="top", help="Legend position for PCA plot")
parser$add_argument("--label_offset_x_", type="double", default=2, help="Label offset x for PCA plot")
parser$add_argument("--label_offset_y_", type="double", default=2, help="Label offset y for PCA plot")
parser$add_argument("--label_font_size", type="double", default=3, help="Label font size for PCA plot")
parser$add_argument("--point_size_for_pca", type="double", default=8, help="Point size for PCA plot")
parser$add_argument("--color_histogram_by_group", type="logical", default=TRUE, help="Color histogram by group")
parser$add_argument("--set_min_max_for_x_axis_for_histogram", type="logical", default=FALSE, help="Set min/max x-axis for histogram")
parser$add_argument("--minimum_for_x_axis_for_histogram", type="double", default=-1, help="Histogram x-axis minimum")
parser$add_argument("--maximum_for_x_axis_for_histogram", type="double", default=1, help="Histogram x-axis maximum")
parser$add_argument("--legend_font_size_for_histogram", type="double", default=10, help="Legend font size for histogram")
parser$add_argument("--legend_position_for_histogram", type="character", default="top", help="Legend position for histogram")
parser$add_argument("--number_of_histogram_legend_columns", type="integer", default=6, help="Number of legend columns for histogram")
...
moo |> 
    normalize_counts(
        ...
        samples_to_rename = parse_vector_with_default(args$samples_to_rename, c("")),
